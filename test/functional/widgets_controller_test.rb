...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { description: @widget.description, name: @widget.name, user_id: @widget.user_id }
    end
  ...
  test "should update widget" do
    put :update, id: @widget, widget: { description: @widget.description, name: @widget.name, user_id: @widget.user_id }
    assert_redirected_to widget_path(assigns(:widget))
  end
